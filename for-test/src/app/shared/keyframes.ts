...
export const swingIn = [
  style({transform: 'rotate3d(0, 0, 1, 15deg)', opacity: .2, offset: .2}),
  style({transform: 'rotate3d(0, 0, 1, -10deg)', opacity: .4, offset: .4}),
  style({transform: 'rotate3d(0, 0, 1, 5deg)', opacity: .6, offset: .6}),
  style({transform: 'rotate3d(0, 0, 1, -5deg)', opacity: .8, offset: .8}),
  style({transform: 'none', offset: 1})
];
...
export const backOutLeft = [
  ...
  style({transform: 'translateX(0px) scale(0.7)', opacity: .7, offset: 0.2}),
  style({transform: 'translateX(-2000px) scale(0.7)', opacity: .7, offset: 1}),
];
...
export const zoomIn = [
  style({transform: 'scale3d(0.1, 0.1, 0.1)', opacity:  0, offset: 0}),
  style({transform: 'scale3d(0.25, 0.25, 0.25)', opacity: .25, offset: .25}),
  style({transform: 'scale3d(0.5, 0.5, 0.5)', opacity: .5, offset: .5}),
  style({transform: 'scale3d(0.75, 0.75, 0.75)', opacity: .75, offset: .75}),
